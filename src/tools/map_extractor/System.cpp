...
uint32 CONF_TargetBuild = 12340;              // 3.3.5a.12340
...
uint32 const Builds[] = {12340, 13164, 13205, 13287, 13329, 13596, 13623, 13914, 14007, 14333, 14480, 14545, 15005, 15050, 15211, 15354, 15595, 0};
